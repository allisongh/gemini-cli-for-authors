# GEMINI.md for Google Workspace documentation projects

## 1. Project Overview & Purpose

This project contains the English source files for Google Workspace's public
developer documentation, which is published on
https://developers.google.com/workspace. Its purpose is to provide
comprehensive guides, tutorials, and reference materials to help developers
understand and use Google Workspace products, APIs, and services effectively.
