...
2. Review the public Gemini CLI documentation to learn where these changes
   might impact the content: https://www.geminicli.com/docs.
3. Respond with the following sections and details:

### Commit summary

For any noteworthy changes from those commits, return a release note with the
following format:
